...
✅ **Database (Optional)** – You can connect this dashboard to a **SQL database** for real-time data.
...
👉 [https://github.com/Thanush2001/Power_BI.git](https://github.com/Thanush2001/Power_BI.git)
